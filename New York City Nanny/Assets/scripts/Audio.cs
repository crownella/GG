...
public class Audio : MonoBehaviour {
    ...
    public AudioSource PlaySound(AudioClip clip, float volume, float pitch, bool loop = false)
    {
        ...
        audioSources[index].clip = clip; //will give the audio source the clip given
        ...
        return audioSources[index]; //how do i use this to turn off a certain audio source?????
    }
